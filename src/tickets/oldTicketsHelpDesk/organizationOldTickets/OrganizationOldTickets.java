package tickets.oldTicketsHelpDesk.organizationOldTickets;
...
public class OrganizationOldTickets extends ButtonCalls implements Initializable {
    ...
    public void loadTickets(TitledPane titledPane, Organization selectedOrganization, Queue queue)
    {
        ...
        Collection<Ticket> tickets = dbm.getTicketsPerQueue(queue.getQueueID());
        ...
        for(Ticket t: tickets)
        {
            ...
            Organization otherOrg = dbm.findOtherTicketOrganization(t.getTicketID(), selectedOrganization);
